...
class GetParamModel {
  ...
  factory GetParamModel.fromRawJson(String str) =>
      GetParamModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetParamModel.fromJson(Map<String, dynamic> json) => GetParamModel(
        id: json["id"],
